...
class FunctionInferenceEngine:
    ...
    PAIN_INFERENCE = {
        "analytics": {
            ...
            "attack": "Position data/BI talent who can create transparent reporting and dashboard capabilities.",
        },
        "finance": {
            ...
            "attack": "Position finance talent who can strengthen financial operations and reporting.",
        },
        "operations": {
            ...
            "attack": "Position operations talent who can drive efficiency and process improvement.",
        },
        "supply_chain": {
            ...
            "attack": "Position supply chain talent who can optimize planning and fulfillment.",
        },
        "marketing": {
            ...
            "attack": "Position marketing talent who can drive measurable growth.",
        },
        "sales": {
            ...
            "attack": "Position sales talent who can drive revenue growth and pipeline health.",
        },
        "customer_support": {
            ...
            "attack": "Position CS talent who can enhance customer experience and retention.",
        },
        "product": {
            ...
            "attack": "Position product talent who can clarify roadmap and delivery.",
        },
        "engineering": {
            ...
            "attack": "Position engineering talent who can improve delivery and reliability.",
        },
        "hr": {
            ...
            "attack": "Position HR talent who can strengthen people operations.",
        },
        "recruiting": {
            ...
            "attack": "Position recruiting talent who can accelerate hiring and improve quality.",
        },
        "legal": {
            ...
            "attack": "Position legal talent who can manage risk and compliance.",
        },
        "manufacturing": {
            ...
            "attack": "Position manufacturing talent who can drive production excellence.",
        },
        "retail": {
            ...
            "attack": "Position retail operations talent who can drive store-level results.",
        },
        "it": {
            ...
            "attack": "Position IT talent who can strengthen infrastructure and support.",
        },
        "healthcare": {
            ...
            "attack": "Position healthcare talent who can stabilize clinical operations and patient outcomes.",
        },
        "hospitality": {
            ...
            "attack": "Position hospitality talent who can standardize guest experience across locations.",
        },
        "education": {
            ...
            "attack": "Position education talent who can improve learning outcomes and program effectiveness.",
        },
        "trades": {
            ...
            "attack": "Position trades talent who can hold quality while scaling field capacity.",
        },
        "transportation": {
            ...
            "attack": "Position transportation operations talent who can hold schedule integrity at scale.",
        },
        "food_service": {
            ...
            "attack": "Position food service talent who can standardize kitchen operations across locations.",
        },
    }
    ...
    def infer_pain_from_patterns(self, functional_areas: list[str]) -> dict:
        ...
        if not functional_areas:
            return {
                ...
                "attack": "Gather more hiring intelligence.",
            }
